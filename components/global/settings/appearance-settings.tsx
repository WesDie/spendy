...
export default function AppearanceSettings() {
  ...
  return (
    <SettingsCard
      ...
      label="These settings are applied globally and are saved locally."
    >
          ...
          >
            {colorThemes.map(({ name, light, dark }) => (
              ...
              >
                ...
                <div
                  className={`p-1 rounded-lg group-hover:bg-muted-foreground/20 transition-colors duration-300 ${
                    themeColor === name
                      ? `ring-2 ${
